...
class RobertaISTS(torch.nn.Module):
    def __init__(self, num_classes, val_type_classes, dropout_rate, hidden_neurons):
        ...
        self.linear5 = nn.Linear(in_features=1024, out_features=hidden_neurons, bias=True)
        self.linear6 = nn.Linear(in_features=hidden_neurons, out_features=val_type_classes, bias=True)
    ...
    def forward(self, x):
        ...
        x3 = self.relu2(self.linear5(x))
        out3 = F.log_softmax(self.linear6(x3), dim=1)
